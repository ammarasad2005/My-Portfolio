  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div>
        <button
          onClick={onBack}
          className="inline-flex items-center gap-2 text-xs font-mono font-bold text-[#555555] hover:text-[#1F1F1F] hover:underline transition-colors cursor-pointer"
        >
      ...
      <div className="flex flex-col gap-3">
        ...
        <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-[680px]">
          {project.tagline}
        </p>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 pt-2">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-1.5 bg-[#1F1F1F] text-white px-3.5 py-1.5 rounded text-xs font-medium hover:bg-[#333333] transition-colors"
            >
              <span>Live Demo</span>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 bg-[#EAE5DC] border border-[#D8D0C3] text-[#1F1F1F] px-3.5 py-1.5 rounded text-xs font-medium hover:bg-[#E0D8CE] transition-colors"
            >
              <span>Source</span>
      ...
      <div className="relative w-full h-[240px] sm:h-[360px] bg-[#DCD5C9] rounded-lg border border-[#D0C7B8] p-2 shadow-sm overflow-hidden">
        {/* Top Tape Clip */}
        <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-16 h-4.5 bg-[#E2D4B9]/90 border border-[#D4C5A9] rotate-[-1deg] z-10"></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
        <div className="flex flex-col gap-2 p-4 bg-[#EAE5DC]/30 border border-[#DDD6C9] rounded-lg">
      ...
      <div className="relative w-full bg-[#EAE1BD]/60 border border-[#D8CEAA] rounded-md p-6 shadow-xs">
        <div className="absolute -top-3 left-8 w-14 h-4 bg-[#F2E7CD]/80 border border-[#D4C5A9]/70 shadow-2xs rotate-[1deg]"></div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs sm:text-sm text-[#333333]">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {project.metrics.map((metric, idx) => (
            <div key={idx} className="flex flex-col p-3.5 bg-[#EAE5DC]/50 border border-[#DDD6C9] rounded-lg">
